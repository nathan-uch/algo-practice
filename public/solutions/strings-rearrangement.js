...
export const StringsRearrangement = new ProblemInfo('Strings Rearrangement', 'Medium', 'Sep 5, 2022', 'Code Signal', 'https://app.codesignal.com/arcade/intro/level-7/PTWhv2oWqd6p4AHB9', 'Check if 2 consecutive strings can be different by only 1 char in an array.', true, true, '#', 'Permutation (DFS) & Recursion', `

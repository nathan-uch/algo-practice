...
export const ChessKnight = new ProblemInfo(
  'Chess Knight', // name
  'Medium', // difficulty
  'Oct 24th, 2022', // date
  'Code Signal', // source
  'https://app.codesignal.com/arcade/intro/level-11/pwRLrkrNpnsbgMndb/solutions', // link
  'Check how many available moves for a knight piece on chess board.', // summary
  true, // completed
  false, // usedHelp
  '', // helpSource
  '', // topics

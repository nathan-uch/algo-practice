...
export const IsMAC48Address = new ProblemInfo(
  'Is MAC48 Address', // name
  'Medium', // difficulty
  'Oct 6th, 2022', // date
  'Code Signal', // source
  'https://app.codesignal.com/arcade/intro/level-10/HJ2thsvjL25iCvvdm', // link
  'Check is string is IEEE 802 format for printing MAC-48 addresses.', // summary
  true, // completed
  false, // usedHelp
  '', // helpSource
  '', // topics

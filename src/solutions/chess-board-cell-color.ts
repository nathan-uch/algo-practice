...
export const ChessBoardCellColor = new ProblemInfo(
  'Chess Board Cell Color', // name
  'Easy', // difficulty
  'Sep 2, 2022', // date
  'Code Signal', // source
  'https://app.codesignal.com/arcade/intro/level-6/t97bpjfrMDZH8GJhi', // link
  'Check if two cell colors on chess board are the same', // summary
  true, // completed
  false, // usedHelp
  '', // helpSource
  '', // topics
  `
    ...
    `, // pseudoCode
  function solution(c1: string, c2: string): boolean {

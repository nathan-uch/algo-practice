...
export const IsBeautifulString = new ProblemInfo(
  'Is Beautiful String', // name
  'Medium', // difficulty
  'Sep 22, 2022', // date
  'Code Signal', // source
  'https://app.codesignal.com/arcade/intro/level-10/PHSQhLEw3K2CmhhXE', // link
  'Check if letters in string appear no more than previous alphabet letter.', // summary
  true, // completed
  false, // usedHelp
  '', // helpSource
  '', // topics

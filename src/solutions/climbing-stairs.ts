...
export const ClimbingStairs = new ProblemInfo(
  'Climbing Stairs', // name
  'Easy', // difficulty
  'Sep 26, 2022', // date
  'Leet Code / Neet Code', // source
  'https://leetcode.com/problems/climbing-stairs/', // link
  'You can take 1 or 2 steps to climb a stairs, find max distinct ways to reach top.', // summary
  true, // completed
  true, // usedHelp
  'https://www.youtube.com/watch?v=Y0lT9Fck7qI&feature=emb_title', // helpSource
  'Bottom-up programming approach, Cache, Memoization, Fibonacci', // topics
  `
  Steps needed:

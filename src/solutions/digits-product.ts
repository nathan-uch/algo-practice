...
export const DigitsProduct = new ProblemInfo(
  'Digits Product', // name
  'Medium', // difficulty
  'Nov 3rd, 2022', // date
  'Code Signal', // source
  'https://app.codesignal.com/arcade/intro/level-12/NJJhENpgheFRQbPRA', // link
  'From integer, find smallest positive integer from product of digits.', // summary
  true, // completed
  false, // usedHelp
  '', // helpSource
  '', // topics
  ...
  function solution(product: number) {
